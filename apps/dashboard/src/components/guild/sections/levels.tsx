...
export function Levels({ guild }: LevelsProps) {
  return (
    <GuildSection
      title="Level System"
      description="Configure member leveling and experience tracking."
      className="flex flex-col gap-4 w-full bg-neutral-900/50 rounded-lg p-4"
    >
      <div className="bg-neutral-800/50 rounded-lg p-4">
        <h3 className="text-lg font-semibold mb-3">Level Configuration</h3>
        <p className="text-neutral-400 mb-4">
          Set up experience gain rates and level rewards.
        </p>
